    ...
    <div className='border-t py-4'>
      ...
      <div className='p-2 space-y-1'>
        ...
        {files?.map((file, index) => (
          <div key={index} onClick={() => setFile(file.id)} className={`flex items-center space-x-1 cursor-pointer text-xs p-1 rounded ${file.focused ? "bg-blue-200 text-black" : "hover:bg-zinc-100"}`} >
            <i className="ri-file-list-2-line text-base"></i>
